...
def _mock_user_center_success(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("backend.api.auth_routes.exchange_code_for_token", _exchange_code_for_token)
    monkeypatch.setattr(
        "backend.api.auth_routes.derive_local_user_profile_from_token",
        lambda token: {
