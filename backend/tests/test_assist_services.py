...
from workflow.schemas import AssistLlmRequest
from workflow.schemas import AssistLlmResponse
...
def test_run_llm_json_task_uses_json_object_mode_and_normalizes_fields(monkeypatch):
    ...
    monkeypatch.setattr("assist.services.get_default_client", lambda: FakeClient())
...
def test_analyze_pagination_builds_evidence_package_prompt(monkeypatch):
    ...
    monkeypatch.setattr("assist.services._run_llm_json_task", fake_run_llm_json_task)
